...
export default function Tab ({ user, setUser }: Props) {
  ...
  return (
    ...
    >
      <Tab.Screen name="EventScreenNavigator" children={() => <EventNavigatorScreen user={user} />} options={{
        tabBarIcon: ({ focused }) => (
      ...
      <Tab.Screen name="Profile" children={() => <ProfileScreen user={user} setUser={setUser} />} options={{
        tabBarIcon: ({ focused }) => (
